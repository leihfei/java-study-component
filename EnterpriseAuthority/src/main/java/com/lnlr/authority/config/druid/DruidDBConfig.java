package com.lnlr.authority.config.druid;
...
public class DruidDBConfig {
    ...
    public ServletRegistrationBean registrationBean() {
        ...
        //登录查看信息的账号密码.
        servletRegistrationBean.addInitParameter("loginUsername", "leihfei");
        servletRegistrationBean.addInitParameter("loginPassword", "leihfei");
        //是否能够重置数据.
