package com.lnlr.jna;/*
 * To change this template, choose Tools | Templates
 * and open the template in the editor.
 */

/*
 * com.lnlr.jna.HCNetSDK.java
 *
...
//SDK接口说明,com.lnlr.jna.HCNetSDK.dll
...
//NET_DVR_Login()参数结构
    ...
    public static class NET_DVR_DEVICEINFO_V30 extends Structure {
        ...
        public byte byMainProto;           //主码流传输协议类型：0- private，1- rtsp，2- 同时支持私有协议和rtsp协议取流（默认采用私有协议取流）
        public byte bySubProto; // 子码流传输协议类型：0- private，1- rtsp，2- 同时支持私有协议和rtsp协议取流（默认采用私有协议取流）
        /**
...
//播放库函数声明,com.lnlr.jna.PlayCtrl.dll
interface PlayCtrl extends StdCallLibrary {
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary("com.lnlr.jna.PlayCtrl",
            PlayCtrl.class);
